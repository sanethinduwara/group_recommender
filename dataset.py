...
class Dataset(object):
    ...
    def load_movies(self):
        ...
        return pd.read_csv('data/ml-1m/' + 'movies.dat', sep='::', names=movie_cols, encoding='latin-1')
# def load_movies(self):
...
#         return pd.read_csv(self.__dataset_path + 'u.item', sep='|', names=movie_cols, encoding='latin-1')
    ...
    def load_ratings(self):
        ...
        return pd.read_csv('data/ml-1m/' + 'ratings.dat', sep='::', names=rating_cols, encoding='latin-1', skiprows=0)
